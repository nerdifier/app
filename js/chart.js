...
//THIS CODE ISN'T MINE. IT BELONGS TO SOMEONE IN JSDELIVR SO PLS DONT MISUNDERSTNAD
//if u have an MIT license for this code then here i mentioned it
 ...
 */
    ...
    class tn extends $s {
        ...
        calculateLabelRotation() {
            ...
            a = this.maxHeight - Zs(t.grid) - e.padding - Js(t.title, this.chart.options.font),
            r = Math.sqrt(c * c + d * d),
        ...
        fit() {
            ...
            if (o) {
                ...
                t.height = Zs(n) + o) : (t.height = this.maxHeight,
                t.width = Zs(n) + o),
    ...
    function to(t, e, i, s) {
        const {points: n, options: o} = e
          ...
          , c = function(t) {
            return t.stepped ? Fe : t.tension || "monotone" === t.cubicInterpolationMode ? Ve : Jn
        }(o);
    ...
    var $o = Object.freeze({
        ...
        CategoryScale: class extends tn {
            ...
            parse(t, e) {
                ...
                return ( (t, e) => null === t ? null : J(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : po(i, t, l(e, t), this._addedLabels), i.length - 1)
            }
            determineDataLimits() {
                const {minDefined: t, maxDefined: e} = this.getUserBounds();
    ...
    function La(t, e, i) {
        ...
        return {
            xAlign: i.xAlign || e.xAlign || Ta(t, e, i, s),
            yAlign: s
        }
    }
    function Ea(t, e, i, s) {
    ...
    function Va(t, e, i, s) {
        ...
        return void 0 === n ? Fa[e].call(i, s) : n
    }
    class Ba extends $s {
        ...
        getTitle(t, e) {
            const {callbacks: i} = e
              , s = Va(i, "beforeTitle", this, t)
              , n = Va(i, "title", this, t)
              , o = Va(i, "afterTitle", this, t);
            let a = [];
            return a = Da(a, Ca(s)),
            a = Da(a, Ca(n)),
            a = Da(a, Ca(o)),
        ...
        getBeforeBody(t, e) {
            return Ia(Va(e.callbacks, "beforeBody", this, t))
        }
        getBody(t, e) {
            const {callbacks: i} = e
              , s = [];
            return u(t, (t => {
                const e = {
                  ...
                  , n = za(i, t);
                Da(e.before, Ca(Va(n, "beforeLabel", this, t))),
                Da(e.lines, Va(n, "label", this, t)),
                Da(e.after, Ca(Va(n, "afterLabel", this, t))),
                s.push(e)
            }
            )),
            s
        ...
        getAfterBody(t, e) {
            return Ia(Va(e.callbacks, "afterBody", this, t))
        }
        getFooter(t, e) {
            const {callbacks: i} = e
              , s = Va(i, "beforeFooter", this, t)
              , n = Va(i, "footer", this, t)
              , o = Va(i, "afterFooter", this, t);
            let a = [];
            return a = Da(a, Ca(s)),
            a = Da(a, Ca(n)),
            a = Da(a, Ca(o)),
        ...
        _createItems(t) {
            ...
            for (a = 0,
            r = e.length; a < r; ++a)
                l.push(Oa(this.chart, e[a]));
            return t.filter && (l = l.filter(( (e, s, n) => t.filter(e, s, n, i)))),
            t.itemSort && (l = l.sort(( (e, s) => t.itemSort(e, s, i)))),
            u(l, (e => {
                const i = za(t.callbacks, e);
                s.push(Va(i, "labelColor", this, e)),
                n.push(Va(i, "labelPointStyle", this, e)),
                o.push(Va(i, "labelTextColor", this, e))
            }
            )),
            this.labelColors = s,
        ...
        update(t, e) {
            ...
            if (s.length) {
                ...
                const e = this._size = Aa(this, i)
                  , a = Object.assign({}, t, e)
                  , r = La(this.chart, i, a)
                  , l = Ea(i, a, r, this.chart);
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Ra(this, i.titleAlign, i),
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Ra(this, i.footerAlign, i),
